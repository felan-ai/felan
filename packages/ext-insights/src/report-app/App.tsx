  ...
  return (
    <div className="container">
      ...
      <div className="footer">
        Generated by Felan Insights · {allData.export?.generatedAt ? new Date(allData.export.generatedAt).toLocaleString() : 'unknown time'} · static snapshot; run /insights again to refresh
      </div>
    </div>
  );
}
