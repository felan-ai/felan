...
- Own `AgentRuntime`, `HostAgentRuntime`, provider-aware model tiers, the Felan base prompt, capabilities, resource/session composition, coding tools, and the public Pi composition surface.
