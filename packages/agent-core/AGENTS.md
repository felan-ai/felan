...
- Keep this package feature-neutral except for the small structured logger. Subagents, progressive context, Prewalk, local settings/storage, and UI policy belong to their extension or application.
