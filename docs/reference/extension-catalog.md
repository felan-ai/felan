...
| [`@felan-ai/ext-session-compaction`](../../packages/ext-session-compaction/README.md) | Bounded verified compaction and active-lineage recall | `session_recall` | Pi session lifecycle; enabled by default locally |
