# Comparing Felan Code with local coding agents

Felan Code is not the same kind of product as every agent in this list. Some are
vendor clients, some are general-purpose coding-agent harnesses, and Pi is the
foundation Felan Code composes. These pages make the tradeoffs explicit instead of
...
| --- | --- |
| [Felan Code vs OpenAI Codex](codex.md) | Do you prefer Felan Code's portable host and task graph, or Codex's structured tools and OS-enforced sandbox? |
| [Felan Code vs OpenCode](opencode.md) | Do you prefer Felan Code's explicit host/resource boundary, or OpenCode's broad configurable local harness? |
| [Felan Code vs Claude Code](claude-code.md) | Do you want a portable extension layer and evidence workflow, or Claude Code's mature approvals, integrations, and team features? |
| [Felan Code vs Pi](pi.md) | Do you want Felan Code's batteries-included local host, or Pi's smaller extension-oriented foundation? |
| [Felan Code vs Oh My Pi](oh-my-pi.md) | Do you want Felan Code's portable host contracts and narrower policy, or OMP's very broad native tool surface? |
...
4. cases where Felan Code is the better fit;
...
## Shared Felan Code starting points
...
All five pages use the same Felan Code baseline: local Felan Code `0.12.10` at commit
