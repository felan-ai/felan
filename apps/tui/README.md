...
It restores the ordinary coding tools when another model is selected. Optional
request controls live in `$FELAN_AGENT_DIR/codex.json`; see the extension
package README for the three supported fields.
