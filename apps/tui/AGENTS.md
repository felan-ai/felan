...
- Preserve the fixed resource boundary: source-controlled built-ins, Felan-owned settings/appends/agents, the Agent Core-selected cwd `AGENTS.md`/`CLAUDE.md`, and explicit global/workspace Agent Skills. Ambient Pi project resources and external extensions remain filtered.
